...
| Discover behavior | `DISCOVER_CONTRACT.md`, `server/src/discover/`, `src/api/discoverApi.ts`, `src/pages/DiscoverPage.tsx` | source adapter + saved-item/interest integration + ranking unit + React tests |
