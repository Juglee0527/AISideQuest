...
- Saved lists remain available during source/cache failure. Saved snapshots, explicit interests, and unexpired owned analytics are exported in user-data schema version 4 and removed by account deletion.
