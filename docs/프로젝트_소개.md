...
Discover는 외부 채용·계약 기회, 개발 소식과 커뮤니티 주제를 정제해 원문으로 연결하는 다음 확장입니다. 현재는 제품 계약과 인증된 API 공통 model까지 완료했으며 외부 source item과 `/discover` 화면은 아직 제공하지 않습니다.
...
- 외부 item을 조회·click·save해도 AISideQuest point를 지급하지 않습니다.
